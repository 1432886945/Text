...
public class CustomButton extends AppCompatButton {
    ...
    private void setAttributeSet(Context context, AttributeSet attrs) {
        ...
        if (!isInEditMode()) {
            ...
            int normalTextColor = a.getColor(R.styleable.customButton_BnormalTextColor, 0);
            int selectedTextColor = a.getColor(R.styleable.customButton_BselectedTextColor, 0);
            ...
            a.recycle();
            setTextSize(14);
            setTextColor(context.getResources().getColor(R.color.home_titel));
            setBackgroundColor(context.getResources().getColor(R.color.bg_light));
     ...
     * @param isEnableSelected    是否打开选中状态
     */
    public void setBackGround(int normalSolid, int roundButtonRadius, boolean isEnableSelected) {
        normalSolid = getResources().getColor(normalSolid);
    ...
    public void setEnabled(boolean enabled) {
        if (enabled) {
            ...
            if (radius != 0) {
                ...
                tempBackGround.setColor(getResources().getColor(R.color.sdarkgray));
